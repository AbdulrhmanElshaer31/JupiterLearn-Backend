...
const homeWorkSubmission = require("./modules/assignment_submissions/assignment_submissions.routes")
const assignment = require("./modules/assignments/assignments.routes");
const app = express();

app.use(cors());
app.use(express.json());
app.use("/api/homeWorkSubmission", homeWorkSubmission);
